...
def make_fake_packet(attack_type=None):
    ...
    templates = {
        ...
        'DoS': {
            'duration': 0,
            'src_bytes': int(np.random.normal(50000, 10000)),
            ...
            'count': random.randint(420, 512),
            'srv_count': random.randint(420, 512),
            'serror_rate': round(random.uniform(0.85, 1.0), 3),
            'rerror_rate': round(random.uniform(0, 0.1), 3),
            'same_srv_rate': round(random.uniform(0.9, 1.0), 3),
        ...
        'PortScan': {
            ...
            'serror_rate': round(random.uniform(0, 0.1), 3),
            'rerror_rate': round(random.uniform(0.85, 1.0), 3),
            'same_srv_rate': round(random.uniform(0, 0.1), 3),
            'diff_srv_rate': round(random.uniform(0.9, 1.0), 3),
        ...
        'BruteForce': {
            ...
            'srv_count': random.randint(10, 100),
            'serror_rate': round(random.uniform(0, 0.3), 3),
            'rerror_rate': round(random.uniform(0.5, 0.9), 3),
            'same_srv_rate': round(random.uniform(0.9, 1.0), 3),
            'diff_srv_rate': round(random.uniform(0, 0.1), 3),
